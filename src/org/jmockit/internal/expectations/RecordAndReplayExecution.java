...
//   }
   ...
   @Nonnull
   public BaseVerificationPhase startVerifications()
   {
      ...
      verificationPhase = new UnorderedVerificationPhase(this, expectations, invocationInstances, invocationArguments);
