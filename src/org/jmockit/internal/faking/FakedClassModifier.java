...
final class FakedClassModifier extends BaseClassModifier
{
    ...
    */
   FakedClassModifier(
      @Nonnull ClassReader cr, @Nonnull Class<?> realClass, @Nonnull Fake<?> fake, @Nonnull FakeMethods fakeMethods
   ) {
      super(cr);
   ...
   private void generateCallToUpdateFakeState() {
      if (useClassLoadingBridgeForUpdatingFakeState) {
         ...
         mw.visitMethodInsn(
            INVOKESTATIC, "org/jmockit/internal/state/TestRun", "updateFakeState", "(Ljava/lang/String;I)Z", false);
      }
   }
   ...
   private void generateDirectCallToFakeMethod() {
      ...
      if (canProceedIntoConstructor) {
         mw.visitMethodInsn(
            INVOKEVIRTUAL, "org/jmockit/internal/faking/FakeInvocation", "shouldProceedIntoConstructor", "()Z", false);
      }
   }
   ...
   private void generateCodeToObtainFakeInstance(@Nonnull String fakeClassDesc) {
      ...
      mw.visitMethodInsn(
         INVOKESTATIC, "org/jmockit/internal/state/TestRun", "getFake", "(Ljava/lang/String;)Ljava/lang/Object;", false);
   ...
   private void generateCallToCreateNewFakeInvocation(@Nonnull Type[] argTypes, int initialParameterIndex) {
      ...
      mw.visitMethodInsn(
         INVOKESTATIC, "org/jmockit/internal/faking/FakeInvocation", "create",
         "(Ljava/lang/Object;[Ljava/lang/Object;Ljava/lang/String;I" +
         "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/jmockit/internal/faking/FakeInvocation;", false);
   }
