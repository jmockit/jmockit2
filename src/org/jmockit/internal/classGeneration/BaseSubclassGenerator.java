...
public class BaseSubclassGenerator extends BaseClassModifier
{
   ...
   protected BaseSubclassGenerator(
     @Nonnull Class<?> baseClass, @Nonnull ClassReader classReader, @Nullable Type genericMockedType,
      ...
      @Nonnull String desc, @Nullable String signature, @Nullable String[] exceptions)
   {
      ...
      for (org.jmockit.external.asm.Type paramType : org.jmockit.external.asm.Type.getArgumentTypes(desc)) {
   ...
   {
      if (paramType <= org.jmockit.external.asm.Type.INT) {
         return ILOAD;
      }

      switch (paramType) {
         case org.jmockit.external.asm.Type.FLOAT:  return FLOAD;
         case org.jmockit.external.asm.Type.LONG:   return LLOAD;
         case org.jmockit.external.asm.Type.DOUBLE: return DLOAD;
